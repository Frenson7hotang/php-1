...
//jawaaban
echo "<label>First sentence:  </label> \"$first_sentence\" <br>";
echo "Panjang String: ". strlen($first_sentence);
        echo "<br>";
        echo "Jumlah kata: ". str_word_count($first_sentence);
        echo "<br>";
echo "<label>Second sentence:  </label> \"$second_sentence\" <br>";
...
echo "<label>String: </label> \"$string2\" <br>";
 echo "Kata pertama: " . substr($string2, 0, 1) . "<br>" ;
  ...
  echo " Kata Ketiga: " . substr($string2, 7, 10) ;
...
// OUTPUT : "PHP is old but awesome" 
  echo "Berubah Menjadi: ". str_replace("sexy", "awesome", $string3);
